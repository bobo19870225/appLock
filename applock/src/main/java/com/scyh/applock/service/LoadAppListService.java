...
public class LoadAppListService extends IntentService {
    ...
    protected void onHandleIntent(Intent handleIntent) {
        ...
        if (isInitDb) {
            ...
            if (appList.size() > dbList.size()) { //如果有安装新应用
                ...
                List<CommLockInfo> commlist = new ArrayList<CommLockInfo>();
                HashMap<String, ResolveInfo> hashMap = new HashMap<String, ResolveInfo>();
                for (ResolveInfo info : appList) {
    ...
    public void initFavoriteApps() {
        ...
        List<FaviterInfo> faviterInfos = new ArrayList<FaviterInfo>();
