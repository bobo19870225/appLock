...
//            if (isSort) {
//                List<CommLockInfo> sysList = new ArrayList<CommLockInfo>();
//                List<CommLockInfo> userList = new ArrayList<CommLockInfo>();
...
//            }
    ...
    private class LoadLockAsyncTask extends AsyncTask<String, Void, List<CommLockInfo>> {
        ...
        protected List<CommLockInfo> doInBackground(String... params) {
            ...
            List<CommLockInfo> list = new ArrayList<CommLockInfo>();
            for (CommLockInfo info : commLockInfos) {
                if (info.isLocked()) {
                    list.add(info);
                }
